...
df = pd.read_csv("combine_with_draft_info_fixed.csv")
...
if filtered.empty:
    st.markdown(
        "<p style='color: #000; font-size: 1.1rem; text-align: center; margin-top: 1rem;'>No players found with selected criteria.</p>",
        unsafe_allow_html=True
    )
else:
